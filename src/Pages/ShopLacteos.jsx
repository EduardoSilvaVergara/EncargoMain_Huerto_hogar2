...
//Data
import productsData from './../json/ProductLacteos.json';
...
function ShopLacteos() {
    ...
    const addToCart = (product) => {
        ...
        const productWithCategory = { ...product, category: 'lacteos' }; // 🔹 Agrega la categoría específica de esta tienda
        ...
        <>
            ...
            <div className="shop-container">
                <div className="container">
                    <h1 className="text-center py-4 fw-semibold">🥛 Lacteos 🥛</h1>
