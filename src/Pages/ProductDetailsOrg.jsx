...
function ProductDetailsOrg() {
    ...
    useEffect(() => {
        const loadProduct = async () => {
            try {
                ...
                // Obtener productos de la colección "Organicos"
                const data = await getProductos("Organicos");
    ...
    const addToCart = (product) => {
        ...
        const productWithCategory = { ...product, category: 'organicos' };
    ...
    return (
        <>
            <ol className="section-banner py-3 position-relative">
                ...
                <li className="position-relative active"><Link to='/shopOrganicos' className='ps-5'>Orgánicos</Link></li>
            ...
            <div className="container py-5">
                <div className="row">
                    ...
                    <div className="col-xl-6">
                        ...
                        <p><strong>Código: </strong>Or-{product.id}</p>
                    </div>
                </div>
            </div>
...
export default ProductDetailsOrg