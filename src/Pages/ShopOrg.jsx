...
//Data
import productsData from '../ProductOrganicos.json';
        ...
        <>
            ...
            <div className="shop-container">
                <div className="container">
                    <h1 className="text-center py-4 fw-semibold">🌿 Orgánicos 👨‍🌾</h1>
                            ...
                            <div className='col-md-3 mb-4' key={product.id}>
                                <div key={product.id}>
                                    <div className="product-item mb-5 text-center position-relative">
                                        ...
                                        <Link to={`/ProductOrganicos/${product.id}`} className='text-decoration-none text-black'>
