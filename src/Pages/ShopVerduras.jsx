...
//Data
import productsData from './../json/ProductVerduras.json';

function ShopVerduras() {
    ...
    const addToCart = (product) => {
        ...
        const productWithCategory = { ...product, category: 'verduras' }; // 🔹 Agrega la categoría específica de esta tienda
        ...
        <>
            ...
            <div className="shop-container">
                <div className="container">
                    <h1 className="text-center py-4 fw-semibold">🥕 Verduras 🥕</h1>
                            ...
                            displayedProducts.map(product => (
                                <div className='col-md-3 mb-4' key={product.id}>
                                    <div className="product-item mb-5 text-center position-relative">
                                        ...
                                        <Link to={`/productVerduras/${product.id}`} className='text-decoration-none text-black'>
