...
function ProductDetailsLacteos() {
    const { id } = useParams();
    ...
    return (
        <>
            <ol className="section-banner py-3 position-relative">
                ...
                <li className="position-relative active"><Link to='/shopLacteos' className='ps-5'>Lácteos</Link></li>
            ...
            <div className="container py-5">
                <div className="row">
                    ...
                    <div className="col-xl-6">
                        ...
                        <p><strong>Código: </strong>Lc-{product.id}</p>
                    </div>
                </div>
            </div>
...
export default ProductDetailsLacteos