...
function ProductDetailsVerduras() {
    const { id } = useParams();
    ...
    return (
        <>
            <ol className="section-banner py-3 position-relative">
                ...
                <li className="position-relative active"><Link to='/shopVerduras' className='ps-5'>Verduras</Link></li>
            ...
            <div className="container py-5">
                <div className="row">
                    ...
                    <div className="col-xl-6">
                        ...
                        <p><strong>Código: </strong>Ve-{product.id}</p>
                    </div>
                </div>
            </div>
...
export default ProductDetailsVerduras